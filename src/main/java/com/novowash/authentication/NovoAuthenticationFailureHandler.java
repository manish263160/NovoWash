...
public class NovoAuthenticationFailureHandler implements AuthenticationFailureHandler {

	private static final Logger logger = Logger.getLogger(NovoAuthenticationFailureHandler.class);
